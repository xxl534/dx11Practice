...
#pragma region IcosahedronTessellationEffect
IcosahedronTessellationEffect::IcosahedronTessellationEffect(ID3D11Device * device, const std::wstring & filename)
	: Effect(device, filename)
{
...
IcosahedronTessellationEffect::~IcosahedronTessellationEffect()
{
...
IcosahedronTessellationEffect* Effects::IcosahedronTessellationFX = NULL;

void Effects::InitAll(ID3D11Device* device)
{
	BasicFX = new BasicEffect(device, L"FX/Basic.fx");
	BlurFX = new BlurEffect(device, L"FX/Blur.fx");
	IcosahedronTessellationFX = new IcosahedronTessellationEffect(device, L"FX/IcosahedronTessellation.fx");
}
...
void Effects::DestroyAll()
{
	SafeDelete(BasicFX);
	SafeDelete(BlurFX);
	SafeDelete(IcosahedronTessellationFX);
}
#pragma endregion
