...
class IcosahedronTessellationEffect : public Effect
{
public:
	IcosahedronTessellationEffect(ID3D11Device* device, const std::wstring& filename);
	~IcosahedronTessellationEffect();
...
public:
	...
	static IcosahedronTessellationEffect* IcosahedronTessellationFX;
};
#pragma endregion
