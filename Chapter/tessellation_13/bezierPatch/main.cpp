...
void BasicTessellating::DrawScene()
{
	...
	Effects::BezierTessellationFX->SetFogStart(15.f);
	Effects::BezierTessellationFX->SetFogRange(175.f);
	...
	{
		ID3DX11EffectPass* pass = Effects::BezierTessellationFX->TessTech->GetPassByIndex(p);
		...
		Effects::BezierTessellationFX->SetDiffuseMap(NULL);
