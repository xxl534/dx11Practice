...
bool NormalMapApp::Init()
{
	...
	HR(CreateDDSTextureFromFile(md3dDevice,
		L"Textures/floor.dds", NULL, &mFloorTexSRV ));

	HR(CreateDDSTextureFromFile(md3dDevice,
		L"Textures/stone.dds", NULL, &mStoneTexSRV ));

	HR(CreateDDSTextureFromFile(md3dDevice,
		L"Textures/bricks.dds", NULL, &mBrickTexSRV ));

	HR(CreateDDSTextureFromFile(md3dDevice,
		L"Textures/floor_nmap.dds", NULL, &mStoneNormalTexSRV));

	HR(CreateDDSTextureFromFile(md3dDevice,
		L"Textures/bricks_nmap.dds", NULL, &mBrickNormalTexSRV));
...
void NormalMapApp::BuildShapeGeometryBuffers()
{
...
void NormalMapApp::BuildSkullGeometryBuffers()
{
