...
#pragma region CylinderEffect
class CylinderEffect : public Effect
{
public:
	CylinderEffect(ID3D11Device* device, const std::wstring& filename);
	~CylinderEffect();
	...
	void SetMaterial(const Material& mat) { Mat->SetRawValue(&mat, 0, sizeof(Material)); }
	void SetDiffuseMap(ID3D11ShaderResourceView* tex) { DiffuseMap->SetResource(tex); }
	void SetHeight(float f) { Height->SetFloat(f); }
	...
	ID3DX11EffectScalarVariable* FogStart;
	ID3DX11EffectScalarVariable* FogRange;
	ID3DX11EffectScalarVariable* Height;
	ID3DX11EffectVariable* DirLights;
	ID3DX11EffectVariable* Mat;
...
{
public:
	SphereEffect(ID3D11Device* device, const std::wstring& filename);
	~SphereEffect();
	...
	void SetMaterial(const Material& mat) { Mat->SetRawValue(&mat, 0, sizeof(Material)); }
	void SetDiffuseMap(ID3D11ShaderResourceView* tex) { DiffuseMap->SetResource(tex); }
	void SetIteration(int i) { Iteration->SetInt(i); }
	...
	ID3DX11EffectScalarVariable* FogStart;
	ID3DX11EffectScalarVariable* FogRange;
	ID3DX11EffectScalarVariable* Iteration;
	ID3DX11EffectVariable* DirLights;
	ID3DX11EffectVariable* Mat;
...
public:
	...
	static CylinderEffect* CylinderFX;
	static SphereEffect* SphereFX;
};
#pragma endregion
