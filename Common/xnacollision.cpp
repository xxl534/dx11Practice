...
static inline XMVECTOR XMVectorPermute(FXMVECTOR V1,
	FXMVECTOR V2,
	FXMVECTOR VPermute)
{
	return DirectX::XMVectorPermute(V1, V2, XMVectorGetIntX(VPermute), XMVectorGetIntY(VPermute), XMVectorGetIntZ(VPermute), XMVectorGetIntW(VPermute));
}
//-----------------------------------------------------------------------------
